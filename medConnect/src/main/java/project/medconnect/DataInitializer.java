...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Medic medic5 = new Medic("Dr. Michael", "Johnson", "michaeljohnson@hospital.com", "456456456", orthopedics,
        ...
        medicRepository.saveAll(Arrays.asList(medic1, medic2, medic3, medic4, medic5, medic6, medic7, medic8, medic9));
        ...
        patientRepository.saveAll(Arrays.asList(patient1, patient2, patient3, patient4, patient5, patient6, patient7, patient8, patient9, patient10, patient11, patient12, patient13, patient14, patient15));

        // Criação de consultas
        Appointment appointment1 = new Appointment(patient1, cardiology, medic1, "2024-06-02", "10h", "Done", null);
        Appointment appointment2 = new Appointment(patient2, pediatrics, medic2, "2024-06-03", "10h", "Done", null);
        Appointment appointment3 = new Appointment(patient3, cardiology, medic1, "2024-06-03", "11h", "Called", 1);
        Appointment appointment4 = new Appointment(patient4, pediatrics, medic2, "2024-06-03", "11h", "Called", 2);
        Appointment appointment5 = new Appointment(patient5, cardiology, medic1, "2024-06-03", "12h", "Waiting", 3);
        Appointment appointment6 = new Appointment(patient6, pediatrics, medic2, "2024-06-03", "12h", "Waiting", 4);
        Appointment appointment7 = new Appointment(patient7, neurology, medic3, "2024-06-04", "10h", "Scheduled", null);
        Appointment appointment8 = new Appointment(patient8, dermatology, medic4, "2024-06-04", "11h", "Scheduled", null);
        Appointment appointment9 = new Appointment(patient9, orthopedics, medic5, "2024-06-04", "12h", "Scheduled", null);
        Appointment appointment10 = new Appointment(patient10, gynecology, medic6, "2024-06-05", "10h", "Scheduled", null);
        Appointment appointment11 = new Appointment(patient11, cardiology, medic7, "2024-06-05", "11h", "Scheduled", null);
        Appointment appointment12 = new Appointment(patient12, dermatology, medic8, "2024-06-05", "12h", "Scheduled", null);
        Appointment appointment13 = new Appointment(patient13, neurology, medic9, "2024-06-05", "12h", "Scheduled", null);
        Appointment appointment14 = new Appointment(patient14, orthopedics, medic5, "2024-06-05", "12h", "Scheduled", null);
        Appointment appointment15 = new Appointment(patient15, gynecology, medic6, "2024-06-05", "12h", "Scheduled",null);

        appointmentRepository.saveAll(Arrays.asList(appointment1, appointment2, appointment3, appointment4, appointment5, appointment6, appointment7, appointment8, appointment9, appointment10, appointment11, appointment12, appointment13, appointment14, appointment15));
